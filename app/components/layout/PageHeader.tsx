  ...
  return (
    <div className="bg-filter-bar-bg p-3 rounded-lg flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-2 w-full md:w-auto">
        ...
        <select className="bg-white text-black text-sm rounded-md px-3 py-1.5 focus:outline-none w-full sm:w-auto">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button className="bg-sidebar-bg text-white px-4 py-1.5 rounded-md text-sm font-semibold w-full sm:w-auto">
            Aktifkan
          </button>
          <button className="bg-sidebar-bg text-white px-4 py-1.5 rounded-md text-sm font-semibold w-full sm:w-auto">
            Admin Pemda
